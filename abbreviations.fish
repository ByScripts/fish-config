...
abbr sgb 'php app/console generate:bundle'
abbr sgc 'php app/console generate:controller'
abbr sdge 'php app/console doctrine:generate:entity'
abbr sdsc 'php app/console doctrine:schema:create'
